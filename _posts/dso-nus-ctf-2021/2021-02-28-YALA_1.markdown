...
This is the fourth challenge from the Mobile section of DSO-NUS CTF 2021. The challenge wants us to brute force the password for the user.
...
I used the following code to brute force the password.
